...
export const BarangayDetails = ({ barangay, selectedCrop, onClose }: BarangayDetailsProps) => {
  ...
  return (
    <Card 
      className="w-full shadow-lg border-2 border-border/50" 
      style={{ 
    ...
    >
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <CardTitle className="text-foreground text-sm md:text-base truncate">{barangay.name}</CardTitle>
          </div>
          <Button
            variant="ghost"
            size="sm"
      ...
      <CardContent className="space-y-3 md:space-y-4">
        ...
        <div className="space-y-2">
          <h4 className="font-medium text-xs md:text-sm text-foreground flex items-center gap-1">
        ...
        <div className="space-y-2">
          <h4 className="font-medium text-xs md:text-sm text-foreground flex items-center gap-1">
            <Sprout className="w-3 h-3 md:w-4 md:h-4 flex-shrink-0" />
        ...
        <div className="flex gap-2">
          <Button size="sm" className="flex-1 text-xs px-2">
            View Details
          </Button>
